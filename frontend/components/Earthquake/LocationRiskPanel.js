...
export default function LocationRiskPanel({ location, onClose, allEarthquakes }) {
  ...
  return (
    <AnimatePresence>
      ...
      >
        {/* Fixed Header */}
        <div className="flex-shrink-0 bg-white/95 backdrop-blur-sm border-b border-gray-200 p-5 flex items-center justify-between">
